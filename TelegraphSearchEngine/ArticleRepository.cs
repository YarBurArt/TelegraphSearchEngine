...
namespace TelegraphSearchEngine
{
    ...
    public class ArticleRepository(string? connectionString) : IArticleRepository
    {
        private readonly string _connectionString = connectionString ?? @"Data Source=mydatabase.db";
        ...
        private static async Task CreateArticlesTableAsync(SQLiteConnection connection) {
            try {
